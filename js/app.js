...
let slider_about = new Swiper('.slider', {
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.body-slider-control__next',
		prevEl: '.body-slider-control__back',
	},
	/*
	breakpoints: {
		320: {
...
let sliderEyelashes = new Swiper('.slider1', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.body-slider-control1__next1',
		prevEl: '.body-slider-control1__back1',
	},
	/*
	breakpoints: {
		320: {
...
let sliderСosmetology = new Swiper('.slider3', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.body-slider-control2__next2',
		prevEl: '.body-slider-control2__back2',
	},
	/*
	breakpoints: {
		320: {
...
let sliderBeauty = new Swiper('.slider4', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.column-body-screen-3__next',
		prevEl: '.column-body-screen-3__back',
	},
	/*
	breakpoints: {
		320: {
...
let sliderTeam = new Swiper('.slider-screen-5', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
let sliderGallery = new Swiper('.screen-6__slider', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
if (iconMenu != null) {
	...
	iconMenu.addEventListener("click", function (e) {
		if (unlock) {
			...
			menuScreen.classList.toggle("_active");
		}
	});
};
function menu_close() {
