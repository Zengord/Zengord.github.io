...
function nightMode(){
    if(night === false){
        ...
        document.querySelector('.header').classList.add("header-nigh__mode");
        ...
        document.querySelectorAll('.btn-size').forEach(item =>{
            item.style.backgroundColor = "rgb(75, 0, 30, 0.4)";
        ...
        document.querySelector('.header').classList.remove("header-nigh__mode");
...
//Доработать переключения картинок
function imgChange(){ 
    ...
    document.getElementById('btn-white__XS').addEventListener("click", () =>{
        document.getElementById("iPhoneXSp").src = "/img/11.png"
    });

    document.getElementById('btn-black__XS').addEventListener("click", () =>{
        document.getElementById("iPhoneXSp").src = "/img/9.png"
    });

    document.getElementById('btn-gold__XS').addEventListener("click", () =>{
        document.getElementById("iPhoneXSp").src = "/img/10.png"
    });
    ...
    document.getElementById('btn-pink__SE').addEventListener("click", () =>{
        document.getElementById("iPhoneSE").src = "/img/13.png"
    });

    // Settings iphone 12 Pro
    document.getElementById('btn-graphite__12').addEventListener("click", () =>{
        document.getElementById("iPhone12").src = "/img/iphone12/1.png"
    });

    document.getElementById('btn-silver__12').addEventListener("click", () =>{
        document.getElementById("iPhone12").src = "/img/iphone12/2.png"
    });

    document.getElementById('btn-pink__12').addEventListener("click", () =>{
        document.getElementById("iPhone12").src = "/img/iphone12/3.png"
    });

    document.getElementById('btn-pacific-blue__12').addEventListener("click", () =>{
        document.getElementById("iPhone12").src = "/img/iphone12/4.png"
    });
...
// Function for 12 iPhone
function iphone12(btn128, btn256, btn512 ,text_block, pricesBlock){
    document.querySelector(btn128).addEventListener("click", () => {
        document.querySelector(text_block).innerHTML = pricesBlock[0];
    });
    ...
    document.querySelector(btn512).addEventListener("click", () => {
        document.querySelector(text_block).innerHTML = pricesBlock[2];
    });
}
...
function priceChange(){
    ...
    iphone12("#btn128__12", "#btn256__12", "#btn512__12", "#iphone12-text", prices12);
}
